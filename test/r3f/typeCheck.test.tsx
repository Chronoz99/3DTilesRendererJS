import { EnvironmentControls, TilesRenderer } from '3d-tiles-renderer/r3f';
...
test( 'TilesRenderer accepts a cached root tileset', () => {

	const cachedRootJson = {
		asset: { version: '1.0' },
		root: { children: [] },
	};
	const element = <TilesRenderer cachedRootJson={ cachedRootJson } />;
