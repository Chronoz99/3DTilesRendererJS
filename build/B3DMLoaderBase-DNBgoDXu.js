import { b as m, F as S, U as T, L as le, f as I, a as F, Q as U, P as D } from "./constants-BuP7M5oB.js";
...
class Pe {
  ...
  constructor(e = null, s = null) {
    this.rootLoadingState = T, this.rootTileset = null, this.rootURL = e, this.cachedRootJson = s, this.fetchOptions = {}, this.plugins = [], this.queuedTiles = [], this.cachedSinceLoadComplete = /* @__PURE__ */ new Set(), this.isLoading = !1;
    const n = new le();
    n.unloadPriorityCallback = ye;
    const r = new I();
    r.maxJobs = 25, r.priorityCallback = V;
    const a = new I();
    a.maxJobs = 5, a.priorityCallback = V;
    const i = new I();
    i.maxJobs = 25, i.priorityCallback = (o, l) => {
      const d = o.parent, h = l.parent;
      return d === h ? 0 : d ? h ? r.priorityCallback(d, h) : -1 : 1;
    }, this.processedTiles = /* @__PURE__ */ new WeakSet(), this.visibleTiles = /* @__PURE__ */ new Set(), this.activeTiles = /* @__PURE__ */ new Set(), this.usedSet = /* @__PURE__ */ new Set(), this.loadingTiles = /* @__PURE__ */ new Set(), this.lruCache = n, this.downloadQueue = r, this.parseQueue = a, this.processNodeQueue = i, this.stats = {
      inCacheSinceLoad: 0,
      inCache: 0,
      queued: 0,
      downloading: 0,
  ...
  loadRootTileset() {
    ...
    let s = this.rootURL;
    return this.invokeAllPlugins((r) => s = r.preprocessURL ? r.preprocessURL(s, null) : s), this.cachedRootJson ? Promise.resolve(this.cachedRootJson).then((r) => (this.preprocessTileset(r, s), r)) : this.invokeOnePlugin((r) => r.fetchData && r.fetchData(s, this.fetchOptions)).then((r) => {
...
//# sourceMappingURL=B3DMLoaderBase-DNBgoDXu.js.map
