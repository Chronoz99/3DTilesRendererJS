import { c as e, f as t, u as n, x as r } from "./renderer-CASIahiy.js";
...
var c = class {
	...
	loadRootTileset() {
		let e = this.tiles;
		return e.cachedRootJson && this._processResponse(e.cachedRootJson), e.invokeOnePlugin((e) => e !== this && e.loadRootTileset && e.loadRootTileset());
	}
	_processResponse(e) {
		if (this.auth.sessionToken === null && e) {
			let t = e.root;
			if (t) {
				let e = (t) => {
					if (t.content && t.content.uri) {
						let [, e] = t.content.uri.split("?");
						return new URLSearchParams(e).get("session");
					}
				...
				this.auth.sessionToken = e(t);
			} else e.session && (this.auth.sessionToken = e.session);
		}
	}
	getAttributions(e) {
...
//# sourceMappingURL=plugins-BBrI4L2j.js.map