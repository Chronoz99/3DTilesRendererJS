...
var G = class {
	...
	constructor(e = null, t = null) {
		this.rootLoadingState = 0, this.rootTileset = null, this.rootURL = e, this.cachedRootJson = t, this.fetchOptions = {}, this.plugins = [], this.queuedTiles = [], this.cachedSinceLoadComplete = /* @__PURE__ */ new Set(), this.isLoading = !1, this.processedTiles = /* @__PURE__ */ new WeakSet(), this.visibleTiles = /* @__PURE__ */ new Set(), this.activeTiles = /* @__PURE__ */ new Set(), this.usedSet = /* @__PURE__ */ new Set(), this.loadingTiles = /* @__PURE__ */ new Set(), this.lruCache = V, this.downloadQueue = H, this.parseQueue = U, this.processNodeQueue = W, this.stats = {
			inCacheSinceLoad: 0,
			inCache: 0,
			queued: 0,
			downloading: 0,
	...
	loadRootTileset() {
		let e = this.rootURL;
		return this.invokeAllPlugins((t) => e = t.preprocessURL ? t.preprocessURL(e, null) : e), this.cachedRootJson ? Promise.resolve(this.cachedRootJson).then((t) => (this.preprocessTileset(t, e), t)) : this.invokeOnePlugin((t) => t.fetchData && t.fetchData(e, this.fetchOptions)).then((t) => {
...
//# sourceMappingURL=renderer-CASIahiy.js.map